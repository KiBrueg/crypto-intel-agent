...
<head>
  ...
  <style>
    ...
    *{{box-sizing:border-box}} html{{background:var(--bg)}} body{{margin:0;min-height:100vh;background:radial-gradient(circle at 10% -12%,rgba(230,177,126,.36),transparent 34%),radial-gradient(circle at 88% 0%,rgba(168,95,61,.16),transparent 28%),linear-gradient(135deg,#fffdf8 0%,#fbf7ef 46%,#f2e6d6 100%);font-family:'Source Sans 3',system-ui,-apple-system,'Segoe UI',Roboto,sans-serif;color:var(--text);font-feature-settings:'ss01';}}
    ...
    .pattern-visual .grid{{stroke:rgba(45,45,45,.09);stroke-width:1}} .pattern-visual .path{{fill:none;stroke:#2d2d2d;stroke-width:2.4;stroke-linecap:round;stroke-linejoin:round}} .pattern-visual .guide{{stroke:#d2694e;stroke-width:1.8;stroke-dasharray:5 4;fill:none}} .pattern-visual .neckline,.pattern-visual .triangle-lines{{stroke:#d2694e;stroke-width:1.8;stroke-dasharray:5 4;fill:none}} .pattern-visual .candle{{stroke:#2d2d2d;stroke-width:1.2}} .pattern-visual .candle.up{{fill:#3f7a56}} .pattern-visual .candle.down{{fill:#b54a3a}}
