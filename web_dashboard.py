...
from trader_assistant.mind_cards import build_mind_card, build_historical_mind_card, save_mind_card, record_user_choice, mind_card_detail, apply_experience_calibration
...
<head>
  ...
  <style>
    ...
    *{{box-sizing:border-box}} html{{background:var(--bg)}} body{{margin:0;min-height:100vh;background:radial-gradient(circle at 10% -12%,rgba(230,177,126,.36),transparent 34%),radial-gradient(circle at 88% 0%,rgba(168,95,61,.16),transparent 28%),linear-gradient(135deg,#fffdf8 0%,#fbf7ef 46%,#f2e6d6 100%);font-family:'Source Sans 3',system-ui,-apple-system,'Segoe UI',Roboto,sans-serif;color:var(--text);font-feature-settings:'ss01';}}
    ...
    .hist-stats{{margin:12px 0;padding:12px;border:1px solid var(--line);border-radius:16px;background:rgba(255,253,248,.78)}}.hist-stats h4{{margin:0 0 8px}}.histStatBars{{height:8px;background:rgba(45,45,45,.08);border-radius:999px;overflow:hidden;margin:3px 0 7px}}.histStatBars span{{display:block;height:100%;border-radius:999px}}.histStatBars .good{{background:#3f7a56}}.histStatBars .bad{{background:#b54a3a}}.histStatBars .warn{{background:#d2694e}}.histStatProfile{{margin:8px 0 4px}}
    ...
    .pattern-visual{{width:100%;height:86px;margin:8px 0 6px;border:1px solid var(--line);border-radius:10px;background:linear-gradient(180deg,#fffdfa,#f5eee5)}}
    .pattern-visual .grid{{stroke:rgba(45,45,45,.09);stroke-width:1}} .pattern-visual .path{{fill:none;stroke:#2d2d2d;stroke-width:2.4;stroke-linecap:round;stroke-linejoin:round}} .pattern-visual .harmonic-leg{{fill:none;stroke:#2d2d2d;stroke-width:2.1;stroke-linecap:round;stroke-linejoin:round}} .pattern-visual .prz-zone{{fill:rgba(210,105,78,.18);stroke:#d2694e;stroke-width:1.4}} .pattern-visual .range-box{{fill:rgba(210,105,78,.10);stroke:#d2694e;stroke-width:1.5;stroke-dasharray:5 4}} .pattern-visual .fakeout-marker{{fill:#d2694e;stroke:#7a2f22;stroke-width:1}} .pattern-visual .guide{{stroke:#d2694e;stroke-width:1.8;stroke-dasharray:5 4;fill:none}} .pattern-visual .wedge-lines,.pattern-visual .neckline,.pattern-visual .triangle-lines{{stroke:#d2694e;stroke-width:1.8;stroke-dasharray:5 4;fill:none}} .pattern-visual .candle{{stroke:#2d2d2d;stroke-width:1.2}} .pattern-visual .candle.up{{fill:#3f7a56}} .pattern-visual .candle.down{{fill:#b54a3a}}
...
<body><div class="wrap">
  ...
  <div class="grid">
    ...
    <div>
      ...
      <div class="card section" style="margin-top:16px"><h3>Market Mind Cards</h3><p class="small">Simple training shell: choose ↑ Growth / ↓ Fall / Skip, compare with AI, and later verify against real market outcomes.</p><button class="btn secondary" onclick="showPatternGuide()">Pattern cheat sheet / Подсказка: паттерны + FAQ</button><div id="patternGuidePanel" class="pattern-guide"><h4>Pattern cheat sheet</h4><p class="small">Быстрый справочник: не сигнал к покупке/продаже, а визуальная подсказка для чтения графика.</p><h4>Графические паттерны</h4><div class="pattern-grid"><div class="pattern-card"><b>Head and Shoulders</b><svg class="pattern-visual" viewBox="0 0 160 86" role="img" aria-label="Head and Shoulders visual"><path class="grid" d="M0 22H160M0 44H160M0 66H160"/><rect class="candle up" x="12" y="52" width="8" height="18"/><rect class="candle up" x="36" y="34" width="8" height="22"/><rect class="candle down" x="70" y="14" width="8" height="36"/><rect class="candle down" x="104" y="34" width="8" height="22"/><rect class="candle down" x="132" y="56" width="8" height="16"/><path class="path" d="M10 68L40 34L60 58L74 12L92 58L108 35L142 68"/><path class="neckline" d="M32 58L122 58"/></svg><span>Голова и плечи: часто разворот после тренда; ждут пробой neckline.</span></div><div class="pattern-card"><b>Inverse Head and Shoulders</b><svg class="pattern-visual" viewBox="0 0 160 86" role="img" aria-label="Inverse Head and Shoulders visual"><path class="grid" d="M0 22H160M0 44H160M0 66H160"/><rect class="candle down" x="14" y="24" width="8" height="18"/><rect class="candle down" x="42" y="44" width="8" height="22"/><rect class="candle up" x="72" y="52" width="8" height="24"/><rect class="candle up" x="104" y="44" width="8" height="22"/><rect class="candle up" x="132" y="20" width="8" height="18"/><path class="path" d="M12 20L42 55L61 31L76 74L94 31L112 55L146 20"/><path class="neckline" d="M32 31L122 31"/></svg><span>Зеркальный разворот вверх после падения.</span></div><div class="pattern-card"><b>Double Top / Double Bottom</b><svg class="pattern-visual" viewBox="0 0 160 86" role="img" aria-label="Double Top / Bottom visual"><path class="grid" d="M0 22H160M0 44H160M0 66H160"/><rect class="candle up" x="20" y="42" width="8" height="22"/><rect class="candle down" x="48" y="18" width="8" height="24"/><rect class="candle up" x="84" y="42" width="8" height="18"/><rect class="candle down" x="116" y="18" width="8" height="26"/><path class="path" d="M14 66L50 18L78 60L120 18L148 66"/><path class="guide" d="M42 20H128M72 60H150"/></svg><span>Двойная вершина/дно: тест уровня дважды, важен пробой поддержки/сопротивления.</span></div><div class="pattern-card"><b>Triangle</b><svg class="pattern-visual" viewBox="0 0 160 86" role="img" aria-label="Triangle visual"><path class="grid" d="M0 22H160M0 44H160M0 66H160"/><rect class="candle up" x="22" y="32" width="8" height="26"/><rect class="candle down" x="54" y="40" width="8" height="18"/><rect class="candle up" x="86" y="42" width="8" height="14"/><rect class="candle down" x="118" y="44" width="8" height="12"/><path class="path" d="M18 30L50 60L82 40L110 56L142 47"/><path class="triangle-lines" d="M16 28L145 46M16 70L145 46"/></svg><span>Symmetrical / Ascending / Descending: сжатие волатильности перед импульсом.</span></div><div class="pattern-card"><b>Flag / Pennant</b><svg class="pattern-visual" viewBox="0 0 160 86" role="img" aria-label="Flag / Pennant visual"><path class="grid" d="M0 22H160M0 44H160M0 66H160"/><rect class="candle up" x="18" y="48" width="8" height="26"/><rect class="candle up" x="36" y="30" width="8" height="30"/><rect class="candle up" x="54" y="16" width="8" height="32"/><rect class="candle down" x="88" y="28" width="8" height="16"/><rect class="candle up" x="118" y="24" width="8" height="16"/><path class="path" d="M18 72L38 44L58 18L86 34L118 28L146 38"/><path class="guide" d="M80 24L145 34M78 48L145 58"/></svg><span>Флаг/вымпел: пауза после импульса; часто continuation pattern.</span></div><div class="pattern-card"><b>Cup and Handle</b><svg class="pattern-visual" viewBox="0 0 160 86" role="img" aria-label="Cup and Handle visual"><path class="grid" d="M0 22H160M0 44H160M0 66H160"/><rect class="candle down" x="22" y="24" width="8" height="24"/><rect class="candle down" x="52" y="46" width="8" height="18"/><rect class="candle up" x="82" y="45" width="8" height="18"/><rect class="candle up" x="112" y="22" width="8" height="22"/><rect class="candle down" x="132" y="34" width="8" height="13"/><path class="path" d="M18 24C34 78 91 78 116 24M116 24C130 50 142 45 150 36"/><path class="guide" d="M18 24H124"/></svg><span>Чашка с ручкой: округлая база и небольшой откат перед возможным пробоем.</span></div><div class="pattern-card"><b>Wedge</b><svg class="pattern-visual" viewBox="0 0 160 86" role="img" aria-label="Wedge visual"><path class="grid" d="M0 22H160M0 44H160M0 66H160"/><rect class="candle up" x="18" y="30" width="8" height="26"/><rect class="candle down" x="48" y="38" width="8" height="22"/><rect class="candle up" x="78" y="37" width="8" height="18"/><rect class="candle down" x="108" y="42" width="8" height="14"/><rect class="candle down" x="132" y="48" width="8" height="12"/><path class="path" d="M18 30L48 60L78 38L108 56L140 49"/><path class="wedge-lines" d="M14 24L144 46M14 72L144 54"/></svg><span>Сужающийся канал, часто предупреждает об истощении движения.</span></div><div class="pattern-card"><b>Range breakout / fakeout</b><svg class="pattern-visual" viewBox="0 0 160 86" role="img" aria-label="Range breakout / fakeout visual"><path class="grid" d="M0 22H160M0 44H160M0 66H160"/><rect class="range-box" x="24" y="28" width="92" height="36" rx="4"/><rect class="candle up" x="28" y="40" width="8" height="18"/><rect class="candle down" x="54" y="34" width="8" height="20"/><rect class="candle up" x="80" y="42" width="8" height="16"/><rect class="candle up" x="108" y="20" width="8" height="18"/><circle class="fakeout-marker" cx="112" cy="19" r="5"/><rect class="candle down" x="132" y="44" width="8" height="24"/><path class="path" d="M20 50L50 35L80 55L112 18L136 68"/><path class="guide" d="M24 28H118M24 64H118"/></svg><span>Пробой диапазона или ложный вынос с возвратом внутрь.</span></div></div><h4>Гармонические паттерны</h4><div class="pattern-grid"><div class="pattern-card"><b>Gartley</b><svg class="pattern-visual" viewBox="0 0 160 86" role="img" aria-label="Gartley harmonic visual"><path class="grid" d="M0 22H160M0 44H160M0 66H160"/><rect class="prz-zone" x="120" y="34" width="24" height="34" rx="4"/><path class="harmonic-leg" d="M16 68L44 18L72 52L102 28L132 62"/><path class="guide" d="M16 68H132M44 18H132"/><text x="12" y="77" font-size="9">X</text><text x="42" y="15" font-size="9">A</text><text x="70" y="62" font-size="9">B</text><text x="100" y="24" font-size="9">C</text><text x="132" y="74" font-size="9">D</text></svg><span>XABCD-структура с Fibonacci зонами; ищут PRZ и реакцию цены.</span></div><div class="pattern-card"><b>Butterfly</b><svg class="pattern-visual" viewBox="0 0 160 86" role="img" aria-label="Butterfly harmonic visual"><path class="grid" d="M0 22H160M0 44H160M0 66H160"/><rect class="prz-zone" x="128" y="8" width="22" height="28" rx="4"/><path class="harmonic-leg" d="M14 56L42 18L72 49L103 32L140 14"/><path class="guide" d="M14 56H140M42 18H140"/><text x="10" y="66" font-size="9">X</text><text x="40" y="15" font-size="9">A</text><text x="70" y="59" font-size="9">B</text><text x="101" y="29" font-size="9">C</text><text x="140" y="12" font-size="9">D</text></svg><span>Глубокий разворотный XABCD; D-точка часто за экстремумом X.</span></div><div class="pattern-card"><b>Bat / Crab</b><svg class="pattern-visual" viewBox="0 0 160 86" role="img" aria-label="Bat / Crab harmonic visual"><path class="grid" d="M0 22H160M0 44H160M0 66H160"/><rect class="prz-zone" x="118" y="48" width="26" height="28" rx="4"/><path class="harmonic-leg" d="M16 64L46 18L76 42L104 24L134 70"/><path class="guide" d="M16 64H134M46 18H134"/><text x="12" y="76" font-size="9">X</text><text x="44" y="15" font-size="9">A</text><text x="74" y="53" font-size="9">B</text><text x="102" y="21" font-size="9">C</text><text x="134" y="81" font-size="9">D</text></svg><span>Bat/Crab: глубокие Fibonacci-структуры; D/PRZ требует строгого подтверждения.</span></div><div class="pattern-card"><b>ABCD</b><svg class="pattern-visual" viewBox="0 0 160 86" role="img" aria-label="ABCD harmonic visual"><path class="grid" d="M0 22H160M0 44H160M0 66H160"/><path class="harmonic-leg" d="M20 64L56 22L92 62L128 22"/><path class="guide" d="M20 64H92M56 22H128"/><text x="16" y="76" font-size="9">A</text><text x="54" y="18" font-size="9">B</text><text x="90" y="74" font-size="9">C</text><text x="128" y="18" font-size="9">D</text></svg><span>Базовая гармоническая структура равных/пропорциональных движений AB и CD.</span></div><div class="pattern-card"><b>Cypher / PRZ</b><svg class="pattern-visual" viewBox="0 0 160 86" role="img" aria-label="Cypher harmonic visual"><path class="grid" d="M0 22H160M0 44H160M0 66H160"/><rect class="prz-zone" x="124" y="38" width="24" height="30" rx="4"/><path class="harmonic-leg" d="M16 62L42 20L74 66L108 30L136 58"/><path class="guide" d="M42 20H136M74 66H136"/><text x="12" y="74" font-size="9">X</text><text x="40" y="17" font-size="9">A</text><text x="72" y="78" font-size="9">B</text><text x="106" y="27" font-size="9">C</text><text x="136" y="70" font-size="9">D</text></svg><svg class="pattern-visual" viewBox="0 0 160 86" role="img" aria-label="PRZ harmonic visual"><path class="grid" d="M0 22H160M0 44H160M0 66H160"/><path class="harmonic-leg" d="M18 68L52 20L82 54L112 32L136 58"/><rect class="prz-zone" x="118" y="42" width="28" height="28" rx="5"/><path class="guide" d="M118 42H146M118 70H146"/><text x="122" y="58" font-size="10">PRZ</text></svg><span>Cypher/PRZ: точность уровней важнее похожей картинки; вход только после реакции.</span></div></div><h4>FAQ по сокращениям</h4><div class="pattern-grid"><div class="pattern-card"><b>SMC = Smart Money Concepts</b><span>Структура рынка, ликвидность, order blocks, BOS/CHOCH.</span></div><div class="pattern-card"><b>R/R = Risk/Reward</b><span>Соотношение потенциальной прибыли к риску.</span></div><div class="pattern-card"><b>VWAP = Volume Weighted Average Price</b><span>Средняя цена с учётом объёма; часто важна для intraday.</span></div><div class="pattern-card"><b>FOMO = Fear Of Missing Out</b><span>Импульсивный вход из страха упустить движение.</span></div><div class="pattern-card"><b>EMA = Exponential Moving Average</b><span>Экспоненциальная скользящая средняя, быстрее реагирует на цену.</span></div><div class="pattern-card"><b>RSI / ATR</b><span>RSI — momentum/перекупленность; ATR — средняя волатильность.</span></div></div></div><div class="row"><div><label class="small">Drill</label><select id="mindcardmode"><option value="mixed">Смешанная тренировка</option><option value="quick_scalps">Быстрые движения</option><option value="breakout_reads">Пробои</option><option value="fakeout_defense">Ложные пробои</option><option value="vwap_level_reclaim">Отскоки / возврат к уровню</option><option value="order_book_sense">Стакан и ликвидность</option></select></div><div><label class="small">Risk size</label><select id="mindcardsize"><option value="small">Small</option><option value="medium" selected>Medium</option><option value="large">Large</option></select></div></div><button class="btn secondary" onclick="loadMindCard()">New Mind Card</button><div id="mindcardcockpit" class="metrics" style="margin-top:12px"></div><div id="mindcardbody" class="small"></div><div class="row"><button class="btn secondary" onclick="chooseMindCard('up')">↑ Growth</button><button class="btn secondary" onclick="chooseMindCard('down')">↓ Fall</button></div><button class="btn secondary" onclick="chooseMindCard('skip')">Skip / unclear</button></div>
      ...
      <div class="card section" style="margin-top:16px"><h3>Global News Impact</h3><p class="small">War / sanctions / bans / leaders: shows whether world headlines create growth or fall pressure for crypto and stocks, and why.</p><div id="globalnewsimpact"></div><button class="btn secondary" onclick="scanGlobalNewsImpact()">Scan global market news</button></div>
...
<script>
const $=id=>document.getElementById(id); let lastSnapshot=null, autoTimer=null, lastSetupId=null, currentMindCard=null, miniMindCard=null, miniHistory=[], miniPrefetchedCard=null, miniPrefetching=false, currentGlobalNewsImpact=null;
...
async function scanNewsImpact(){{try{{$('newsimpact').innerHTML='<p class="small">Scanning RSS macro/news…</p>'; const r=await fetch('/api/news-impact?limit_per_feed=6'); const n=await r.json(); renderNewsImpact(n); renderGlobalNewsImpact(n.global_impact);}}catch(e){{$('newsimpact').innerHTML='<p class="error">'+(e.stack||e)+'</p>';}}}}
async function scanGlobalNewsImpact(){{try{{$('globalnewsimpact').innerHTML='<p class="small">Scanning war/sanctions/bans/leaders headlines…</p>'; const r=await fetch('/api/news-impact?limit_per_feed=8'); const n=await r.json(); renderGlobalNewsImpact(n.global_impact); if(!$('newsimpact').innerHTML) renderNewsImpact(n);}}catch(e){{$('globalnewsimpact').innerHTML='<p class="error">'+(e.stack||e)+'</p>';}}}}
...
function worldNewsFactor(){{const g=currentGlobalNewsImpact; if(!g)return null; const crypto=g.crypto_bias||'mixed', stocks=g.stocks_bias||'mixed'; const cats=Object.keys(g.category_counts||{{}}).slice(0,4).join(', ')||'no major category'; const top=(g.cards||[])[0]; const why=top&&top.why?top.why:g.headline; return `World News / Мировые новости — Crypto impact: ${{crypto}}; Stocks impact: ${{stocks}}; categories: ${{cats}}. ${{why}}`;}}
function cardReasonsWithWorldNews(card){{const reasons=[...(card.ai_reason||[])]; const f=worldNewsFactor(); if(f && !reasons.some(x=>String(x).includes('World News / Мировые новости'))) reasons.push(f); return reasons;}}
function renderHistoricalStats(card){{const hs=card.historical_stats||((card.features||{{}}).historical_stats)||null; if(!hs||!hs.sample_size)return ''; const p=hs.match_profile||{{}}; const pct=x=>Math.round((Number(x)||0)*100); const bar=(label,val,cls)=>`<div><div class="small">${{label}} <b>${{pct(val)}}%</b></div><div class="histStatBars"><span class="${{cls}}" style="width:${{Math.max(2,pct(val))}}%"></span></div></div>`; return `<div class="hist-stats" id="historicalStatsBlock"><h4>Historical Similarity Stats</h4><div class="metrics"><div class="metric"><div class="l">Sample</div><div class="v">${{hs.sample_size}}</div></div><div class="metric"><div class="l">Stat view</div><div class="v ${{hs.stat_direction==='up'?'good':(hs.stat_direction==='down'?'bad':'warn')}}">${{hs.stat_direction}}</div></div><div class="metric"><div class="l">Stat confidence</div><div class="v">${{pct(hs.stat_confidence)}}%</div></div><div class="metric"><div class="l">Filter</div><div class="v mono">${{hs.selected_filter||'n/a'}}</div></div></div><div>${{bar('Growth/up',hs.up_rate,'good')}}${{bar('Fall/down',hs.down_rate,'bad')}}${{bar('Flat/skip',hs.flat_rate,'warn')}}</div><p class="small histStatProfile">Profile: trend=${{p.trend_bucket||'n/a'}} · RSI=${{p.rsi_bucket||'n/a'}} · VWAP=${{p.vwap_bucket||'n/a'}} · R/R=${{p.rr_bucket||'n/a'}} · FOMO=${{p.fomo_bucket||'n/a'}} · Volume=${{p.volume_bucket||'n/a'}} · Range=${{p.range_bucket||'n/a'}} · Fakeout=${{p.fakeout_bucket||'n/a'}} · edge ${{pct(hs.stat_edge)}}% · avg ${{fmt(hs.avg_change_pct)}}%</p><span class="small mono">stat_direction=${{hs.stat_direction}} · selected_filter=${{hs.selected_filter||'n/a'}}</span></div>`;}}
function renderExperienceCalibration(card){{const c=card.experience_calibration||((card.features||{{}}).experience_calibration)||null; if(!c||!c.enough_data)return ''; const pct=x=>Math.round((Number(x)||0)*100); return `<div class="hist-stats experience-calibration"><h4>Accumulated Experience</h4><div class="metrics"><div class="metric"><div class="l">Saved outcomes</div><div class="v">${{c.sample_size}}</div></div><div class="metric"><div class="l">AI hit-rate</div><div class="v">${{pct(c.ai_hit_rate)}}%</div></div><div class="metric"><div class="l">recommended realistic confidence</div><div class="v">${{pct(c.recommended_confidence)}}%</div></div><div class="metric"><div class="l">Memory filter</div><div class="v mono">${{c.selected_filter||'exact'}}</div></div></div><p class="small">Experience is accumulated from verified market outcomes, not from assuming user or AI is stronger. It calibrates confidence toward observed reliability for similar buckets.</p></div>`;}}
...
function renderMiniMindCard(card){{const ai=card.ai_direction==='up'?'Growth':(card.ai_direction==='down'?'Fall':'Skip'); const user=card.user_direction?(card.user_direction==='up'?'Growth':(card.user_direction==='down'?'Fall':'Skip')):''; $('miniCardTitle').textContent=`${{card.symbol||'BTCUSDT'}} · ${{ai}} setup`; $('miniCardMeta').textContent=`${{card.exchange||'BINANCE'}} · ${{card.interval||'15m'}} · ${{card.mode||'mixed'}}`; $('miniCardChance').textContent=Math.round((card.ai_confidence||0)*100)+'%'; $('miniCardRisk').textContent='-'+fmt(card.risk_loss_pct)+'%'; $('miniCardRR').textContent=fmt(card.risk_reward_ratio); $('miniCardDesc').innerHTML=`${{user?('You: <b>'+user+'</b> · '+(card.agreement_with_ai?'AI view matches':'AI view differs')+'<br>'):''}}${{cardReasonsWithWorldNews(card).join(' ')}} <span class="mono">FOMO ${{Math.round((card.fomo_score||0)*100)}}%</span>${{renderHistoricalStats(card)}}${{renderExperienceCalibration(card)}}${{user?mindResultComparison(card):''}}`; miniResultHint(card); drawMiniCardChart(card.chart_window||[]);}}
...
function renderGlobalNewsImpact(g){{if(!g||g.error){{$('globalnewsimpact').innerHTML=`<p class="error">${{g&&g.error?g.error:'Global news scan failed'}}</p>`;return;}} currentGlobalNewsImpact=g; const cls=g.crypto_bias==='bullish'?'good':(g.crypto_bias==='bearish'?'bad':'warn'); const stockCls=g.stocks_bias==='bullish'?'good':(g.stocks_bias==='bearish'?'bad':'warn'); const cards=(g.cards||[]).slice(0,8).map(c=>`<li><b>${{c.source||'News'}}</b>: ${{c.title}}<br><span class="small">Crypto: <b class="${{c.crypto_effect==='growth_pressure'?'good':(c.crypto_effect==='fall_pressure'?'bad':'warn')}}">${{c.crypto_effect}}</b> · Stocks: <b>${{c.stocks_effect}}</b> · ${{(c.categories||[]).join(', ')}} · ${{c.why}}</span></li>`).join(''); const watch=(g.what_to_watch||[]).map(x=>`<li>${{x}}</li>`).join(''); $('globalnewsimpact').innerHTML=`<p><b>${{g.headline}}</b></p><div class="metrics"><div class="metric"><div class="l">Crypto pressure</div><div class="v ${{cls}}">${{g.crypto_bias}}</div></div><div class="metric"><div class="l">Stocks pressure</div><div class="v ${{stockCls}}">${{g.stocks_bias}}</div></div><div class="metric"><div class="l">Categories</div><div class="v">${{Object.keys(g.category_counts||{{}}).length}}</div></div></div><h4>World headlines → market pressure</h4><ul class="list">${{cards||'<li>No high-impact world-news headline detected in scanned feeds.</li>'}}</ul><h4>Что смотреть на графике</h4><ul class="list">${{watch}}</ul>`; if(currentMindCard) renderMindCard(currentMindCard); if(miniMindCard) renderMiniMindCard(miniMindCard);}}
    ...
    def do_GET(self):
        ...
        try:
            ...
            if parsed.path == '/api/mind-card/next':
                ...
                try:
                    card = apply_experience_calibration(card, con, min_sample=6)
