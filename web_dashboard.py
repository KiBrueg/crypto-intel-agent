...
<body><div class="wrap">
  ...
  <div class="grid">
    ...
    <div>
      ...
      <div class="card section" style="margin-top:16px"><h3>Learning Autopilot</h3><div id="autopilotstatus"></div><div id="learningautopilot"></div><button class="btn secondary" onclick="runLearningAutopilot()">Run learning cycle</button></div>
...
async function loadAutopilotStatus(){{try{{const r=await fetch('/api/autopilot/status'); const s=await r.json(); renderAutopilotStatus(s);}}catch(e){{}}}}
