...
- Learning Autopilot: saves current live forecasts, later verifies them against future candles, updates accuracy statistics and shows daemon status/heartbeat, pending/verified counts and last forecast.
